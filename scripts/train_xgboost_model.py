...
def main():
    ...
    parser.add_argument('--num_rounds', type=int, default=1000, help='Maximum number of training rounds')
    ...
    parser.add_argument('--lambda_reg', type=float, default=1.0, help='L2 regularization')
    parser.add_argument('--alpha_reg', type=float, default=0.1, help='L1 regularization')
