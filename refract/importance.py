...
def compute_top_feature_shap_values(
    ...
    all_shap = compute_shap_values(model, X_test, compute_interactions=compute_interactions)
    # Get the top feature
    feature_importance = get_top_features_by_shap(all_shap['shap_values'], X_test.columns)
