...
def main():
    parser = argparse.ArgumentParser(description='Train Neural Network Quantile Regression model using cross-validation')
    ...
    parser.add_argument('--hidden_sizes', type=str, default="128,64,32", 
