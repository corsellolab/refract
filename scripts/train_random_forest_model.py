...
def main():
    parser = argparse.ArgumentParser(description='Train Random Forest model using cross-validation')
    ...
    parser.add_argument('--n_threads', type=int, default=8, help='Number of threads for Random Forest')
    parser.add_argument('--n_splits', type=int, default=10, help='Number of cross-validation splits')
    
    # Random Forest hyperparameters
    parser.add_argument('--n_estimators', type=str, default="100,200,500", 
                        help='Comma-separated n_estimators values to try')
    parser.add_argument('--max_depth', type=str, default="10,20,None", 
                        help='Comma-separated max_depth values to try')
    parser.add_argument('--min_samples_split', type=str, default="2,5,10", 
                        help='Comma-separated min_samples_split values to try')
    parser.add_argument('--min_samples_leaf', type=str, default="1,2,4", 
                        help='Comma-separated min_samples_leaf values to try')
    parser.add_argument('--max_features', type=str, default="sqrt,log2,None", 
