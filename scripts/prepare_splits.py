...
from refract.data_split import get_data_for_split, get_data_splits
from refract.feature_selection import get_pearson_correlations, get_top_n_features
from refract.utils import intersect_depmap_ids, load_feature_df, load_response_df


def process_split(
    split_idx, train_response, val_response, test_response, train_features, args
):
...
def main():
    ...
    parser.add_argument(
        ...
        type=str,
        required=True,
        help="Directory to save fold splits and features",
    )
    parser.add_argument(
    ...
    parser.add_argument(
        ...
        type=int,
        default=50,
        help="Number of features to select per class",
    )
    parser.add_argument(
        "--train_val_split",
        type=float,
        default=0.8,
        help="Fraction of data to use for training and validation",
    )
