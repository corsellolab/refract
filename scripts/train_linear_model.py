...
def main():
    parser = argparse.ArgumentParser(description='Train Linear model using cross-validation')
    ...
    parser.add_argument('--n_threads', type=int, default=8, help='Number of threads (not used for linear model)')
    parser.add_argument('--n_splits', type=int, default=10, help='Number of cross-validation splits')
    
    # Linear model hyperparameters
    parser.add_argument('--max_iter', type=int, default=10000, help='Maximum iterations for convergence')
    parser.add_argument('--alphas', type=str, default="0.001,0.01,0.1,1.0,10.0,100.0", 
