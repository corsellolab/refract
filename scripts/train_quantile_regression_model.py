...
def main():
    parser = argparse.ArgumentParser(description='Train Quantile Regression model using cross-validation')
    ...
    parser.add_argument('--n_threads', type=int, default=8, help='Number of threads (not used for quantile regression)')
    ...
    parser.add_argument('--alphas', type=str, default="0.0,0.001,0.01,0.1,1.0,10.0", 
                        help='Comma-separated alpha values for regularization')
    parser.add_argument('--solvers', type=str, default="highs,interior-point", 
